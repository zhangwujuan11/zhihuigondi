	...
	<div class="home">
		<div class="home-top maincon">
			...
			<div class="hometopright">
				<Hometopright :methods="mthods"></Hometopright>
			</div>
		</div>
		<div class="home-down maincon">
		  <Homedown :methods="mthods"></Homedown>
		</div>
	</div>
</template>
<script>
	...
	import {invest,homnescon,siteinfo,cams,camslist,serchall} from '@/utils/home'
	export default {
		name: 'Home',
		components: {
			Titles,
		...
		methods: {
			getmothods(){
				serchall().then(res=>{
					this.mthods=res.data.items
					// console.log(this.mthods)
				})
			},
			pointer(e){
						...
						if(data.code == 200){
							this.videoshow=true
								...
								document.getElementById("hik_iframe").innerHTML =
									...
									'"  id="EZUIKitPlayer-video-container" allowfullscreen="true" allow="autoplay" frameborder="0" class="cams_content_row_left_video" style="height:17.5vw; position: relative;top: -2.8vw;width:100%"></iframe>';
							})
						}else{
