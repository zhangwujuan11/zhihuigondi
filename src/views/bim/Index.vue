	...
	<div class="partybuild">
		<div class="maincon">
			...
			<el-button @click="dra()" type="primary" class="oldtable">
			  构建列表<i class="el-icon-d-arrow-right"></i>
			</el-button>
			...
			<el-form ref="form" :model="form" label-width="65px" >
			  ...
			  <el-form-item label="完成时间">
			      <el-date-picker type="date" placeholder="选择日期" v-model="form.endDate" style="width: 100%;"   format="yyyy 年 MM 月 dd 日"></el-date-picker>
			  </el-form-item>
			 ...
			 <el-form-item label="安全等级">
			  ...
			  <el-form-item style="width: 100%;">
				  <div class="dilofooter">
					<el-button type="success" @click="onSubmit"> <i class="el-icon-check" style="font-weight:1000;"></i> 确认</el-button>
					<el-button @click="dialogfalse"> <i class="el-icon-close" style="font-weight: 1000;"></i>取消</el-button>  
				  </div>
			  </el-form-item>
			</el-form>
			<!-- 桩检详情 -->
...
<script>
	import {firstbim,initColor,getdata, pileByMonth, elementName, detailpart, updatadetail, bridgedetailnew} from "@/utils/bim.js"
		...
		methods:{
			    ...
			    // 加载成功回调函数
			     successCallback(viewMetaData) {
			      ...
			      viewer3D.addEventListener(Glodon.Bimface.Viewer.Viewer3DEvent.ViewAdded, function () {
					...
					mapConfig.modelPosition = [119.3636, 25.519];
					// 设置模型的旋转弧度值
			...
			drawert(){
				...
				pileByMonth().then(res=>{
					this.charts = this.$echarts.init(this.$refs.main, null, {devicePixelRatio: 2.5});
			...
			meetfunction(val){
				...
				if(val.elementType == 'stake'){
				  ...
				  this.viewer3D.getModel().addSelectedComponentsById([val]);
