	...
	<div class="bridge">
				    ...
				    <el-table
				      ...
				      >
					   ...
					   <el-table-column
						 ...
						 >
						 <template slot-scope="scope">
						 	{{scope.row.temperatureSubsidies}}
						 </template>
					   </el-table-column>
					   <el-table-column
					     prop="grossPay"
		...
		<el-dialog
		  ...
		  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
		   ...
		   <el-form-item label="实付" prop="actualPay">
		     <el-input v-model="ruleForm.actualPay"></el-input>
		   </el-form-item>
		  </el-form>
		...
		<el-dialog
		  ...
		  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			 ...
			 <el-form-item label="月" >
			   <el-input v-model="ruleForm.month" disabled></el-input>
			 </el-form-item>
		    <el-form-item label="姓名" prop="workerName">
		      <el-input v-model="ruleForm.workerName" disabled></el-input>
		    </el-form-item>
		   <!-- <el-form-item label="身份证" prop="idNum">
		      <el-input v-model="ruleForm.idNum"></el-input>
		    </el-form-item> -->
	...
	export default{
		...
		filters:{
		 ...
		 data() {
			...
			//     get() {
			//       const _this = this
			//       return _this.ruleForm.payBefore/100
			//     },
			//     set(val) {
			//       this.ruleForm.payBefore = val*100
			//     },
			//   },
			//   keepTwoNum2: {
			//     get() {
			//       const _this = this
			//       return _this.ruleForm.cutCount/100
			//     },
			//     set(val) {
			//       this.ruleForm.cutCount = val*100
			//     },
			// 	 },
			// 	keepTwoNum3: {
			// 	  get() {
			// 	    const _this = this
			// 	    return _this.ruleForm.grossPay/100
			// 	  },
			// 	  set(val) {
			// 	    this.ruleForm.grossPay = val*100
			// 	  },
			// 	   },
			// 	  keepTwoNum4: {
			// 	    get() {
			// 	      const _this = this
			// 	      return _this.ruleForm.temperatureSubsidies/100
			// 	    },
			// 	    set(val) {
			// 	      this.ruleForm.temperatureSubsidies = val*100
			// 	    },
			// 		 },
			// 		keepTwoNum5: {
			// 		  get() {
			// 		    const _this = this
			// 		    return _this.ruleForm.actualPay/100
			// 		  },
			// 		  set(val) {
			// 		    this.ruleForm.actualPay = val*100
			// 		  },
			// 		   },
			// },
		mounted() {
		...
		methods:{
			// 搜索指定信息
			serchdata(){
				console.log(this.mounthyear)
				if(this.mounthyear != null){
					workerSalary({
						deptId:this.parentid,
						pageSize:20,
						...
						this.ruleForm.actualPay=this.ruleForm.actualPay/100
						this.totalCount=res.data.total
					}).catch(()=>{
						this.$message.error('请求错误')
					})
