	...
	<div class="bridge">
				...
				<div>
					...
					<el-table :data="tableData" stripe :header-cell-style="
					   ...
					   >
						...
						<el-table-column prop="variety" label="钢筋类别">
						</el-table-column>
						...
						<el-table-column prop="amount" label="代表数量(t)">
						</el-table-column>
		...
		<el-dialog title="新增钢筋拉伸试验数据" :visible.sync="wokerdilog" width="80%">
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
				...
				<el-form-item label="代表数量" prop="amount">
					<el-input v-model="ruleForm.amount"></el-input>
				</el-form-item>
				<el-form-item label="使用部位" prop="position">
					<el-input v-model="ruleForm.position"></el-input>
				</el-form-item>
				<el-form-item label="钢筋类别" prop="variety">
					<el-input v-model="ruleForm.variety"></el-input>
				</el-form-item>
				<el-form-item label="钢筋直径" prop="diameters">
					<el-input v-model="ruleForm.diameters"></el-input>
				</el-form-item>
				<el-form-item label="生产产家" prop="factory">
...
<script>
	...
	import {rebar,jianli,shigong,addrebar,updaterebar,detelrebar} from '@/utils/synthesize.js'
	import Tabledilog from '@/components/team/Tabledilog.vue'
		...
		methods: {
			...
			deletrow(i) {
				this.$nextTick(()=>{
					this.$confirm('是否确认删除报告编号为' + i.sampleNo + '的数据记录', '提示', {
						...
						detelrebar(i.sampleNo).then(res => {
							if (res.code == 200) {
			...
			rowclick(row,col){
				if(col.label != "操作"){
					...
					this.$store.state.teamtable=true
				}
			}
